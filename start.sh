#!/usr/bin/env bash
# start.sh — avvia in cascata tutti e 7 gli agenti, poi mostra il comando per l'orchestratore.
# Uso:   ./start.sh
# Stop:  ./start.sh stop
...
echo ""
echo "Per l'interfaccia web (chat + trace live su http://localhost:8000):"
echo "  uv run uvicorn gateway.app:app --port 8000"
echo ""
